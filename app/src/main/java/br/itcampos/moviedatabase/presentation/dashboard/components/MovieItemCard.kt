            ...
            .clickable {
                navController.navigate(
                    Screen.MovieDetailsScreen.route +
                            "?movieId=${item?.movieId.toString()}&moviesTitle=${item?.title}"
                )
            },
        ...
        Column(
            ...
            SubcomposeAsyncImage(
                ...
                modifier = Modifier
                    ...
                    .height(160.dp),
                loading = {
                    val composition by rememberLottieComposition(spec = LottieCompositionSpec.RawRes(R.raw.anim_img_loading))
                    LottieAnimation(
